        ...
        return(
          ...
          <Col className="p-1 mb-4" md="6">
            ...
            <Col className="mx-auto" >
              ...
              <Button href="https://ods.od.nih.gov/factsheets/list-all/">{CardA.buttonText}</Button>
            </Col>
          </Col>
          ...
          <Col className="p-1 mb-4" md="6">
            ...
            <Col className="mx-auto" >
              ...
              <Button href="https://ods.od.nih.gov/factsheets/COVID19-HealthProfessional/">{CardB.buttonText}</Button>
            </Col>
          </Col>
        </Row>
        )
